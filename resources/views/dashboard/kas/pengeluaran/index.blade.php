...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
		<a class="btn btn-icon icon-left btn-primary" href="{{ route('admin.kas-pengeluaran.create') }}"> <i class="fas fa-pencil"></i> Tambah Data</a>
	</div>
        ...
        <script>
            $(function(){
                var table = $('#data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('admin.kas-pengeluaran.index') }}",
                    columns : [
