...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
		<a class="btn btn-icon icon-left btn-primary" href="{{ route('adminkas-penerimaan.index') }}"> <i class="fas fa-arrow-left"></i> Back</a>
	</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            @endif
            {{ Form::model($kasPenerimaan, array('route' => array('adminkas-penerimaan.update', $kasPenerimaan->id), 'method' => 'PUT')) }}
